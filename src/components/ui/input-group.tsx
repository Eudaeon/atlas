...
function InputGroupAddon({
  ...
  return (
    <div
      ...
      onClick={(e) => {
        // A portalled child is still a React child, so a click inside a menu
        // or a popover opened from here arrives at this handler. Only a click
        // on the addon itself puts the caret in the input; anything else would
        // take the selection out of whatever was clicked.
