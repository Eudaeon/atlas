    ...
    >
      ...
      >
        <SliderPrimitive.Track
          ...
          className="relative grow rounded-md bg-muted select-none data-horizontal:h-1 data-horizontal:w-full data-vertical:h-full data-vertical:w-1"
        >
          <SliderPrimitive.Indicator
            data-slot="slider-range"
            // The track no longer clips, so the fill rounds its own ends.
            className="relative rounded-md bg-primary select-none data-horizontal:h-full data-vertical:w-full"
          />
        </SliderPrimitive.Track>
